...
export const Cursor = () => {
  ...
  return (
    <>
      <div
        className={`hidden md:block z-50 fixed -translate-x-1/2 -translate-y-1/2 rounded-full pointer-events-none transition-transform
        ${
          hoverButton
            ? "bg-transparent border-2 border-yellow-200 w-5 h-5"
            : "bg-[#ecff44] w-3 h-3"
        }`}
        ref={cursorOutline}
      ></div>
